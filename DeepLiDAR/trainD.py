...
parser.add_argument('--datapath', default='/home/tmt/CV_data/', help='datapath')
...
def train(inputl,gt1,sparse,mask,params):
        ...
        mask: 6x1x256x512
        """
        #gt1 = gt1.permute(0, 3, 1, 2)
        print(inputl.size(), gt1.size(), sparse.size(), mask.size())
        model.train()
